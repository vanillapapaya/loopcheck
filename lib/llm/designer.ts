...
11. 첫 검증 설계(ab_test)는 A/B 테스트를 기본으로 두지 마라. 게임에서 유저마다 난이도·가격·보상을 다르게 주는 것은
    형평성 문제이고, 소규모 팀의 유입으로는 표본도 모자란다. 변경은 전원에게 같게 적용하고, 그 변경에 더 노출되는
...

{
  ...
  "ab_test": {
    ...
    "unit": "비교 방식. 전원에게 같은 변경을 적용한 뒤 어느 집단이 영향을 더 받고 어느 집단을 비교군으로 둘지",
    "min_duration_days": 7,
    "sample_size_note": "관측 계획. 변경 전 며칠을 먼저 관측할지, 두 집단의 격차가 일정했는지 어떻게 확인할지, 표본이 모자랄 때 대신 볼 지표"
  },
